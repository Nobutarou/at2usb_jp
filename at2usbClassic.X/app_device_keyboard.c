...
//        0x25, 0x65, //   LOGICAL_MAXIMUM (101)
        0x25, 0x8b, //   LOGICAL_MAXIMUM (101)
        0x05, 0x07, //   USAGE_PAGE (Keyboard)
        0x19, 0x00, //   USAGE_MINIMUM (Reserved (no event indicated))
//        0x29, 0x65, //   USAGE_MAXIMUM (Keyboard Application)
        0x29, 0x8b, //   USAGE_MAXIMUM (Keyboard Application)
...
#define KEYBOARD_MAX_NUM_KEYS_PRESSED 6
...
void APP_KeyboardInit(void) {
    ...
    //Set the default idle rate to 250ms (until the host sends a SET_IDLE request to change it to a new value)
